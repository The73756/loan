...
/* harmony import */ var _modules_differense__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/differense */ "./src/js/modules/differense.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_differense__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init();
  new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('.form', 'assets/question.php').init();
  new _modules_accordion__WEBPACK_IMPORTED_MODULE_5__["default"]('.module__info-show .plus', '.module__info-show').init();
...
/*#__PURE__*/
function () {
  function Accordion(triggers, parentBlock) {
    ...
    value: function init() {
      ...
      this.trigger.forEach(function (el) {
        el.addEventListener('click', function () {
          el.closest(_this.parentBlock).nextElementSibling.classList.toggle('msg--active');
        });
      });
    }
  }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Differense; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
/*#__PURE__*/
function () {
  function Differense(oldOfficer, newOfficer, items) {
    _classCallCheck(this, Differense);
...
function () {
  ...
  _createClass(Form, [{
    ...
    key: "clearInputs",
    value: function clearInputs(inputs) {
    ...
    value: function initMask() {
      var setCursorPosition = function setCursorPosition(pos, el) {
        el.focus();
      ...
      this.forms.forEach(function (form) {
        ...
        form.addEventListener('submit', function (e) {
          ...
          _this.postData(_this.path, formData).then(function (res) {
            ...
            _this.clearInputs(_this.inputs);
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      try {
        if (this.hanson) {
          if (n === 3) {
            this.hansonTimer = setInterval(function () {
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (el) {
        ...
        el.parentNode.previousElementSibling.addEventListener('click', function (e) {
          e.preventDefault();
          _this2.slideIndex = 1;
      ...
      this.prevBtns.forEach(function (el) {
        el.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
      ...
      this.nextBtns.forEach(function (el) {
        el.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, animate, autoplay, stopable) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, animate, autoplay, stopable));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function init() {
      ...
      try {
        ...
        if (this.autoplay) {
          if (this.stopable) {
            // я не придумал как сюда вклинить делигирование, поэтому код выглядит как калл
            this.slides.forEach(function (slide) {
              slide.addEventListener('mouseenter', function (e) {
                clearInterval(_this4.interval);
              });
              slide.addEventListener('mouseleave', function () {
                _this4.startTime(5000);
              });
            });
          }
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$stopable = _ref.stopable,
      stopable = _ref$stopable === void 0 ? false : _ref$stopable;
